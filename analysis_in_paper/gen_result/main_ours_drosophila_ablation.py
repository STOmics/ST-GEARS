...
out_dir = '/hwfssz1/ST_BIOINTEL/P20Z10200N0039/06.groups/06.3D_reconstruction/xiatianyi/paper/regis_ot/output_data/drosophila_embryo_ours_ablation'  # fixme

# fig_dir = 'E:/REGISTRATION_SOFTWARE/algorithm/cell_level_regist/paste_based/paste/src/SpotMatch_Recons/result_fruitfly_embryo/field_sigma_1_test'
# fig_dir = 'E:/REGISTRATION_SOFTWARE/algorithm/cell_level_regist/paste_based/paste/src/SpotMatch_Recons/result_fruitfly_larva/field_sigma_1_partial_FGW_s_0.85'
# fig_dir = '/hwfssz1/ST_BIOINTEL/P20Z10200N0039/06.groups/06.3D_reconstruction/xiatianyi/SpotMatch_Recons/field_sigma_1_partial_FGW_s_0.85'
fig_dir = '/hwfssz1/ST_BIOINTEL/P20Z10200N0039/06.groups/06.3D_reconstruction/xiatianyi/paper/regis_ot/output_pro_fig/drosophila_embryo_ours_ablation'  # fixme

s = 'E14-16h_a_count_normal_stereoseq.h5ad'
b = 'L3_b_count_normal_stereoseq.h5ad'

path_in = os.path.join(in_dir, s)  # fixme


# 2. generate data
slicesl, anncell_cid = gen_data_drosophila(path=path_in)  # fixme
