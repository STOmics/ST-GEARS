...
input_dir = '/data/users/xiatianyi/online/preprocessed_data/mouse_brain_gpsa'
output_dir = '/data/work/output_data/mouse_brain_gpsa'
n_views = 16
n_spatial_dims = 3
m_X_per_view = 200
...
out_data_slice_li_0 = construct_build_train_save(raw_data_slice_li, [0, 10, 19, 20, 30], 2)  # spatial, spatial_elas
out_data_slice_li_1 = construct_build_train_save(raw_data_slice_li, [1, 11, 19, 21, 31], 2)
out_data_slice_li_2 = construct_build_train_save(raw_data_slice_li, [2, 12, 19, 22, 32], 2)
out_data_slice_li_3 = construct_build_train_save(raw_data_slice_li, [3, 13, 19, 23, 33], 2)
out_data_slice_li_4 = construct_build_train_save(raw_data_slice_li, [4, 14, 19, 24, 34], 2)
out_data_slice_li_5 = construct_build_train_save(raw_data_slice_li, [5, 15, 19, 25, 35], 2)
out_data_slice_li_6 = construct_build_train_save(raw_data_slice_li, [6, 16, 19, 26, 36], 2)
out_data_slice_li_7 = construct_build_train_save(raw_data_slice_li, [7, 17, 19, 27, 37], 2)
out_data_slice_li_8 = construct_build_train_save(raw_data_slice_li, [8, 18, 19, 28, 38], 2)
out_data_slice_li_9 = construct_build_train_save(raw_data_slice_li, [9, 19, 29, 39], 1)

li0, li1, li2 = out_data_slice_li_0, out_data_slice_li_1, out_data_slice_li_2
li3, li4, li5 = out_data_slice_li_3, out_data_slice_li_4, out_data_slice_li_5
li6, li7, li8 = out_data_slice_li_6, out_data_slice_li_7, out_data_slice_li_8
li9 = out_data_slice_li_9
r1_data_slice_li = [li0[0], li1[0], li2[0], li3[0], li4[0], li5[0], li6[0], li7[0], li8[0], li9[0],  # r1: round 1
                    li0[1], li1[1], li2[1], li3[1], li4[1], li5[1], li6[1], li7[1], li8[1], li9[1],
                    li0[3], li1[3], li2[3], li3[3], li4[3], li5[3], li6[3], li7[3], li8[3], li9[2],
                    li0[4], li1[4], li2[4], li3[4], li4[4], li5[4], li6[4], li7[4], li8[4], li9[3]]
...
_ = construct_build_train_save(r1_data_slice_li, [4, 14, 19, 24, 34], [0, 1, 3, 4])
